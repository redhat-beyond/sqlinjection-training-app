		...
		<div class="row marketing">
			<div class="col-lg-6">
				...
				if (!empty($_REQUEST['uid'])) {
					...
					// New input validation to block SQL injection attempts by validating input is consist of alphanumeric username without spaces or special chars
					$valid = false;
					if (preg_match_all('/^[a-zA-Z0-9]*$/', ($_REQUEST['uid']))) {
						$valid = true;
					}
					...
					if ($valid) {
						...
						echo "<font style=\"color:#FF0000\">Invalid username!</font\>";
					}
				}
