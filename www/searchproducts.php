	...
	<div class="container-narrow">
		...
		<div class="searchheader" style="color:white">
			<table>
				...
				if (isset($_POST["searchitem"])) {
					// New input validation to block SQL injection attempts by validating input is consist of alphanumeric product name without spaces or special chars
					$valid = false;
					if (preg_match_all('/^[a-zA-Z0-9]*$/', ($_POST['searchitem']))) {
						$valid = true;
					}
					if ($valid) {
						...
						echo "<tr><td style=\"width:200px\">" . "This" . "</td><td style=\"width:200px\">" . "Won't" . "</td><td style=\"width:450px\">" . "Work" . "</td><td style=\"width:110px\">" . "Here" . "</td></tr>";;
					}
				}
				?>
			</table>
